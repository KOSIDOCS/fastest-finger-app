...
class MainCalculatorWeb extends StatefulWidget {
  const MainCalculatorWeb({Key? key}) : super(key: key);

  @override
  State<MainCalculatorWeb> createState() => _MainCalculatorWebState();
}

class _MainCalculatorWebState extends State<MainCalculatorWeb> {
  @override
  Widget build(BuildContext context) {
    return Consumer<CalculatorState>(
        builder: (context, calculatorState, child) {
      return Container(
        padding: const EdgeInsets.all(20), // this hide in mobile
        decoration: const BoxDecoration(
          color: Color(0xFF9d7fff), // this hide in mobile
                  ...
                  child: Center(
                    child: Align(
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: const Color(0xFF674CE8).withOpacity(0.5),
        ...
        onTap: isSpecialBtn
            ...
            : () {
                if (isSign) {
                  ...
                  context.read<CalculatorState>().addAllTexts(text: text ?? '', isSign: false);
                }
              },
        child: MouseRegion(
          cursor: SystemMouseCursors.click,
